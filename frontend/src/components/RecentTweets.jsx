  ...
  const tweets = [
    {
      ...
      handle: '@ahmadkhan',
      time: '2h ago',
      content: 'Great to see Pakistan making strides in technology! The future looks bright for our tech industry. #PakistanTech',
      sentiment: 'positive',
      likes: 234,
      retweets: 45,
      replies: 12,
    ...
    },
    {
      ...
      handle: '@ayeshaali',
      time: '3h ago',
      content: 'The traffic situation in Karachi needs immediate attention. We need better infrastructure planning. #Karachi',
      sentiment: 'negative',
      likes: 156,
      retweets: 32,
      replies: 28,
    ...
    },
    {
      ...
      handle: '@hassanraza',
      time: '4h ago',
      content: 'Watching the match! Come on Pakistan! 🇵🇰 #PakistanCricket',
      sentiment: 'positive',
      likes: 512,
      retweets: 89,
      replies: 45,
    ...
    },
    {
      ...
      handle: '@fatimasheikh',
      time: '5h ago',
      content: 'Education reforms are essential for our country\'s progress. Investing in our youth is investing in our future.',
      sentiment: 'neutral',
      likes: 198,
      retweets: 56,
      replies: 19,
